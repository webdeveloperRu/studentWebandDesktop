<template>
  <vs-row vs-justify="center" vs-align="center" class="full-height login-register-bg">
    ...
    <vs-card class=" mb-0">
      ...
      <vs-input icon-after="true" size="large" class="w-100 mb-4 mt-2 vs-input-large" icon="person" placeholder="Input your Email" v-model="email" type="email"/>            
      <input class="btn-block btn btn-primary submit-button" type="submit" @click.stop.prevent="checkForm" value="Send"/>
    </form>
     <div class="d-flex justify-content-center mt-3">
        Do you have an account?  &nbsp; <router-link to="/login"> Log In</router-link>
     </div>
    </vs-card>
    </vs-col>
  </vs-row>   
