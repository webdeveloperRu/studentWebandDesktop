<template>
  <vs-row vs-justify="center" vs-align="center" class="full-height login-register-bg">
    ...
    <vs-card class="mb-0">
      ...
      <vs-input icon-after="true" size="large" class="w-100 mb-4 mt-2 vs-input-large" icon="ti-user" icon-pack="ti"           icon-no-border
      ...
      <vs-input icon-after="true" size="large" class="w-100 vs-input-large" type="password" icon="lock" placeholder="Confirm Password" v-model="confirm_pwd"/>
...
export default {
  ...
  computed: {
     inputValid(){
      if(this.validEmail(this.email) && this.pwd && this.confirm_pwd && this.pwd == this.confirm_pwd){
        return false
      } else {
        return true
      }
